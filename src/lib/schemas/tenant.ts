...
export const tenantSchema = z.object({
  ...
  // 3 modos (ver common.ts) — "discreet" é o padrão. Origem presencial
  // (lib/origin.ts) sempre reduz "prominent" pra "discreet" ("off"
  // continua "off") — só vale como está pra origem instagram/direto.
  whatsappMode: whatsappModeSchema.default("discreet"),
